...
Considerando todas estas informações, crie uma função que receba todas essas informações como parâmetros( 3 essenciais + 1 opcional) e 
retorne todas informações organizadas em um `type`
...
- **Entradas/Saídas**
    ...
    function filmes(nomeDoFilme:string,anoDeLançamento:number,genero:GENERO,pontuacao?:number){
      
        

       return {nomeDoFilme,anoDeLançamento,genero,pontuacao}
}

 console.log(filmes("Duna", 2021, GENERO.ACAO, 80))
